...
contract EscrowMilestonesTest is BaseTest {
    ...
    event EscrowCreated(uint256 indexed escrowId, address indexed client, address indexed freelancer, uint256 amount, address token);
    ...
    function test_createEscrowWithMilestones_Success() public {
        ...
        vm.prank(client);
        uint256 escrowId = escrow.createEscrowWithMilestones{value: totalAmount}(
            freelancer,
            arbitrator,
            address(0),  
            milestones
    ...
    function test_createEscrowWithMilestones_ZeroMilestones_Reverts() public {
        ...
        vm.prank(client);
        escrow.createEscrowWithMilestones{value: 1 ether}(
            freelancer,
            arbitrator,
            address(0),
            milestones
    ...
    function test_createEscrowWithMilestones_MismatchedValue_Reverts() public {
        ...
        vm.expectRevert(IEscrow.InvalidAmount.selector);
        vm.prank(client);
        escrow.createEscrowWithMilestones{value: 3 ether}(
            freelancer,
            arbitrator,
            address(0),
            milestones
    ...
    function test_createEscrowWithMilestones_ZeroMilestoneAmount_Reverts() public {
        ...
        vm.expectRevert(IEscrow.InvalidAmount.selector);
        vm.prank(client);
        escrow.createEscrowWithMilestones{value: 0}(
            freelancer,
            arbitrator,
            address(0),
            milestones
    ...
    function test_createEscrowWithMilestones_ZeroAddressFreelancer_Reverts() public {
        ...
        vm.prank(client);
        escrow.createEscrowWithMilestones{value: 5 ether}(
            address(0),
            arbitrator,
            address(0),
            milestones
    ...
    function test_createEscrowWithMilestones_CorrectBalance() public {
        ...
        vm.prank(client);
        escrow.createEscrowWithMilestones{value: totalAmount}(
            freelancer,
            arbitrator,
            address(0),
            milestones
    ...
    function test_createEscrowWithMilestones_MultipleEscrows() public {
        ...
        vm.prank(client);
        uint256 escrowId1 = escrow.createEscrowWithMilestones{value: 5 ether}(
            freelancer,
            arbitrator,
            address(0),
            milestones
        ...
        vm.prank(client);
        uint256 escrowId2 = escrow.createEscrowWithMilestones{value: 5 ether}(
            freelancer,
            arbitrator,
            address(0),
            milestones
    ...
    function test_completeMilestone_Success() public {
        IEscrow.Milestone[] memory milestones = _createSampleMilestones();
        vm.prank(client);
        uint256 escrowId = escrow.createEscrowWithMilestones{value: 4.5 ether}(
            freelancer,
            arbitrator,
            address(0),
            milestones
    ...
    function test_releaseMilestone_Success() public {
        ...
        assertEq(
            uint256(data.state),
            uint256(IEscrow.EscrowState.Funded)
        );
    }
    ...
    function test_releaseMilestone_AllPaid_StateResolved() public {
        IEscrow.Milestone[] memory milestones = _createSingleMilestone();
        vm.prank(client);
        uint256 escrowId = escrow.createEscrowWithMilestones{value: 5 ether}(
            freelancer,
            arbitrator,
            address(0),
            milestones
    ...
    function test_releaseMilestone_ContractBalanceDecreases() public {
        IEscrow.Milestone[] memory milestones = _createSampleMilestones();
        vm.prank(client);
        escrow.createEscrowWithMilestones{value: 4.5 ether}(
            freelancer,
            arbitrator,
            address(0),
            milestones
